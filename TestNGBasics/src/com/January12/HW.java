...
public class HW extends CommonMethods {
	...
	@Test(priority=2)//(priority=2, dependsOnMethods= {"validationOfMessage"}, enabled=false)
	public void validationOfLogo() {
		driver.findElement(By.id("txtUsername")).sendKeys("Admin");
		driver.findElement(By.id("txtPassword")).sendKeys("Hum@nhrm123");
		driver.findElement(By.id("btnLogin")).click();
		boolean isTrue = driver.findElement(By.xpath("//img1[contains(@src,'syntax.png')]")).isDisplayed();
		Assert.assertTrue(isTrue, "Logo Validation TESTED");
		/*
		if (isTrue) {
	...
	public void validationOfMessage() {
		...
		Assert.assertEquals(error, expectedError, "PASSWORD EMPTY WARNING TESTED ");
		/*
