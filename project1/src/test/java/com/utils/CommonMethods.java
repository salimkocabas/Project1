...
public class CommonMethods extends BaseClass{
	...
	public static void gotoHRMSDashboard() {
	...
	public static String takeScreenshot(String fileName) {
		...
		String scrshotFile=Constants.SCREENSHOTS_FILEPATH +fileName+timeStamp;
		try {
			FileUtils.copyFile(file, new File(scrshotFile + ".png"));
		} catch (IOException e) {
